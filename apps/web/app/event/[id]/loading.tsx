      ...
      <aside className="border-keria-forest/20 bg-keria-darker w-full overflow-hidden border-b p-5 lg:w-[380px] lg:border-b-0 lg:border-r">
        ...
        <div className="mb-6">
          <div className="border-keria-forest/30 border-l-2 pl-3">
            <div className="bg-keria-forest/20 h-7 w-44 animate-pulse rounded" />
          </div>
          <div className="bg-keria-forest/10 mt-2 h-4 w-56 animate-pulse rounded" />
          <div className="mt-3 space-y-1">
            <div className="bg-keria-forest/10 h-3 w-40 animate-pulse rounded" />
            <div className="bg-keria-forest/10 h-3 w-24 animate-pulse rounded" />
          </div>
        ...
        <div className="mb-6">
          <div className="border-keria-forest/30 mb-3 flex items-center gap-2 border-l-2 pl-3">
            <div className="bg-keria-forest/20 h-3 w-16 animate-pulse rounded" />
          </div>
          ...
          <div className="space-y-2">
            {Array.from({ length: 3 }).map((_, i) => (
              ...
              >
                <div className="bg-keria-forest/20 flex h-7 w-7 items-center justify-center rounded-full" />
                <div className="flex-1">
                  <div className="bg-keria-forest/20 h-4 w-28 rounded" />
                  <div className="bg-keria-forest/10 mt-1 h-3 w-20 rounded" />
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="space-y-2">
            {Array.from({ length: 2 }).map((_, i) => (
              ...
              >
                ...
                <div className="flex-1">
                  <div className="bg-keria-forest/20 h-4 w-20 rounded" />
                </div>
                <div className="bg-keria-forest/10 h-5 w-12 rounded-full" />
              </div>
            ))}
          </div>
        </div>
