      ...
      <aside className="w-full overflow-hidden border-b border-keria-forest/20 bg-keria-darker p-5 lg:w-[380px] lg:border-b-0 lg:border-r">
        ...
        <div className="mb-6">
          <div className="border-l-2 border-keria-forest/30 pl-3">
            <div className="h-7 w-44 animate-pulse rounded bg-keria-forest/20" />
          </div>
          <div className="mt-2 h-4 w-56 animate-pulse rounded bg-keria-forest/10" />
          <div className="mt-3 space-y-1">
            <div className="h-3 w-40 animate-pulse rounded bg-keria-forest/10" />
            <div className="h-3 w-24 animate-pulse rounded bg-keria-forest/10" />
          </div>
        ...
        <div className="mb-6">
          <div className="mb-3 flex items-center gap-2 border-l-2 border-keria-forest/30 pl-3">
            <div className="h-3 w-16 animate-pulse rounded bg-keria-forest/20" />
          </div>
          ...
          <div className="space-y-2">
            {Array.from({ length: 3 }).map((_, i) => (
              ...
              >
                <div className="flex h-7 w-7 items-center justify-center rounded-full bg-keria-forest/20" />
                <div className="flex-1">
                  <div className="h-4 w-28 rounded bg-keria-forest/20" />
                  <div className="mt-1 h-3 w-20 rounded bg-keria-forest/10" />
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="space-y-2">
            {Array.from({ length: 2 }).map((_, i) => (
              ...
              >
                ...
                <div className="flex-1">
                  <div className="h-4 w-20 rounded bg-keria-forest/20" />
                </div>
                <div className="h-5 w-12 rounded-full bg-keria-forest/10" />
              </div>
            ))}
          </div>
        </div>
